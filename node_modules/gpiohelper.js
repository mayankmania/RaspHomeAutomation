...
var gpioPath = path.join("./GPIOTest");
...
var gpio = function () {
    ...
    this.OutputMode = function () { return "out"; };

    this.InputMode = function () { return "in"; };
    ...
    this.setDirection = function (pinNo, direction) {
        try {
            ...
            console.log(currentGpioPath + " " + direction);
